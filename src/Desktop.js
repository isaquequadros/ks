        ...
        <Layout style={{'minWidth': '1000px'}}>
            ...
            <Layout.Content>
                ...
                <Row justify='center' align='middle' style={{'maxWidth': '2000px'}}>
                    ...
                    <Col style={{'width': '60%'}}>
                        <Row justify='center'>
                        <Image width={400} height={400} preview={false} src={state.coverImage}></Image>
                        </Row>
                    </Col>
                </Row>
                </Row>
                ...
                <Row justify='left' align='top' style={{'maxWidth': '2000px', 'width': '100%'}}>
                    ...
                    <Col style={{'padding': '0px 20px'}}>
                        ...
                        <a href={'/policy/cookies'} target='_blank' rel="noopener noreferrer">
                        ...
                        <Row justify='start' align='middle'>
                        <a href={'/policy/terms'} target='_blank' rel="noopener noreferrer">
                            <Typography.Title level={5}>
                                Terms of Service
                            </Typography.Title>
                        </a>
                                ...
                                <a href={state.discordLink} target='_blank' rel="noopener noreferrer">
                                    <Row justify='start' align='middle'>
                                        ...
                                        <Col style={{'marginLeft': '5px'}}>
                                            <Typography>help.kadima@gmail.com</Typography>  
                                        </Col>
                                    </Row>
