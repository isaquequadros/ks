    ...
    <Typography component='div' style={{'height': '100vh', 'overflow': 'auto'}}>
        <Row type='flex' justify='center' style={{'margin': '20px'}}>
            <Col span={20}>
                ...
                <Typography.Paragraph>
                    Thank you for choosing to be part of our community at kadima solutions (“Company”, “we”, “us”, or “our”). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our notice, or our practices with regards to your personal information, please contact us at contact@kadima solutions.
                </Typography.Paragraph>

                <Typography.Paragraph>
                    When you visit our website <a href='kadima solutions' rel="noopener noreferrer" target='_blank' style={{'color': 'blue'}}>kadima solutions</a>, mobile application, Facebook application, and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. We hope you take some time to read through it carefully, as it is important. If there are any terms in this privacy notice that you do not agree with, please discontinue use of our Sites or Apps and our services.
                </Typography.Paragraph>

                <Typography.Paragraph>
                    This privacy notice applies to all information collected through our website (such as <a href='kadima solutions' rel="noopener noreferrer" target='_blank' style={{'color': 'blue'}}>kadima solutions</a>), mobile application, Facebook application, ("Apps"), and/or any related services, sales, marketing or events (we refer to them collectively in this privacy notice as the "Services").
                </Typography.Paragraph>
                ...
                */}
                ...
                <Typography.Paragraph>
                    This website, mobile application, or Facebook application uses Google Maps APIs. You may find the Google Maps APIs Terms of Service. To better understand Google’s Privacy Policy, please refer to this.
                </Typography.Paragraph>
